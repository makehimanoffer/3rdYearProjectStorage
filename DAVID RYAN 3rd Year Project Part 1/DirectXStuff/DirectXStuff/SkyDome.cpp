...
bool SkyDome::Init(ID3D11Device* device)
{
	bool result;
	...
	m_apexColor = D3DXVECTOR4(0.0f, 0.145f, 0.667f, 1.0f);

	// Set the color at the center of the sky dome.
	m_centerColor =  D3DXVECTOR4(0.81f, 0.38f, 0.66f, 1.0f);
	m_centerColor =  D3DXVECTOR4(0.02f, 0.365f, 0.886f, 1.0f);

	return true;
}


void SkyDome::KillSafely()
{
...
bool SkyDome::InitBuffers(ID3D11Device* device)
{
	VertexType* vertices;
