...
{
	// KillSafely the vertex and pixel shaders as well as the related objects.
	ShutdownShader();
...
bool WaterShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix,
