...
bool Water::Init(ID3D11Device* device, WCHAR* textureFilename, float waterHeight, float waterRadius)
{
	...
	m_normalMapTiling.x = 0.01f;  // Tile ten times over the quad. VALUECHANGE
	m_normalMapTiling.y = 0.02f;  // Tile five times over the quad. VALUECHANGE

	// Init the water translation to zero.
	m_waterTranslation = 0.0f;

	// Set the scaling value for the water normal map.
	m_reflectRefractScale = 0.03f; //get rid of 0 VALUECHANGE
