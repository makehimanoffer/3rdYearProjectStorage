...
//init loads skydome model into m_model structure . Init buffers loads into vert and index buffers. then set two colors of the sky dome
//apex = color at top of skydome. center color
