...
bool SystemBackend::Init()
{
	...
	InitializeWindows(scrWidth, scrHeight);

	//app class object is created and init'd below
	// Create application wrapper object.
...
void SystemBackend::InitializeWindows(int& scrWidth, int& scrHeight)
{
	WNDCLASSEX wc;
	...
	_applicationName = L"David Ryan DirectX Challenge Part 3";
