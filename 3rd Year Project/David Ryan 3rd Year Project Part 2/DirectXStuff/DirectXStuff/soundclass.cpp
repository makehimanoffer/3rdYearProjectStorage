...
//in init directsound. the default sound device is used for convenience. further looking into 
//messing with that.
// see what happens
bool SoundClass::InitializeDirectSound(HWND hwnd)
{
	...
	//want to change the format of the desired format. audiowise.
...
bool SoundClass::LoadWaveFile(char* filename, IDirectSoundBuffer8** secondaryBuffer)
{
	...
	//buffer is the same size as the audio file in this
...
//set position to start playing at the beginning
