...
#include "lightshaderclass.h" //new in 0.5
#include "lightclass.h" //new in 0.5
...
private:
	bool Render(float); //in 0.5 Render takes as float as an argument. before it had no arg
