...
LightShaderClass::LightShaderClass()
{
	...
	m_sampleState = 0;
	m_matrixBuffer = 0;
	m_lightBuffer = 0; //set to null in class constructor
}
...
//the render function for lighting takes in the light direction and light diffuse colors as inputs. then sent to sendshaderproperties
// and then set in the shader.
...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	//new description for lightbuffer
	...
	//a major change from the old status quo is the polygon layout. a third element for the normal vector used for lighting
	...
	//byte stuffing is done here to make it 28 with 4 stuffed.
					   ...
					   D3DXVECTOR4 diffuseColor)
{
	...
	//light buffer is setup same way as matrix constant buffer. lock buffer, get pointer to it. set diffuse color and light direction to pointer
	//once set unlock the buffer and set it in the pixel shader
