...
FontHandler::FontHandler(const FontHandler& other)
{
}
...
bool FontHandler::Initialize(ID3D11Device* device, char* fontFilename, WCHAR* textureFilename)
{
	bool result;
