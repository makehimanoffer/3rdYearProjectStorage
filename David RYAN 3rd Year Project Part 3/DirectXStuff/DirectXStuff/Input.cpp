...
bool Input::Init(HINSTANCE hinstance, HWND hwnd, int scrWidth, int scrHeight)
{
	...
	//init keyboard
	// Init direct input iface for keyboard.
	...
	// Set data format.   a keyboard can use predefined data format.
	...
	// Set coop level of keyboard to not share with other programs.
